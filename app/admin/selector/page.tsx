...
export default function AdminSelectorPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#000', fontFamily: 'var(--font-body)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>

      <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, padding: '18px 40px', borderBottom: '1px solid rgba(255,255,255,0.06)', background: 'rgba(0,0,0,0.8)', backdropFilter: 'blur(20px)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', zIndex: 50 }}>
        ...
        <button
          ...
          style={{ padding: '8px 18px', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, background: 'transparent', color: 'rgba(245,245,247,0.4)', fontSize: 12, cursor: 'pointer', fontFamily: 'var(--font-body)' }}
        >
          Cerrar sesión
        </button>
      </nav>
      ...
      <div style={{ width: '100%', maxWidth: 560, textAlign: 'center' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'clamp(28px, 6vw, 48px)', color: '#f5f5f7', letterSpacing: '-0.025em', marginBottom: 8 }}>
          ¿Qué panel quieres gestionar?
        </h1>
        <p style={{ fontSize: 14, color: 'rgba(245,245,247,0.35)', marginBottom: 48, lineHeight: 1.6 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          <button
            ...
            style={{ padding: '40px 28px', background: 'rgba(232,213,176,0.05)', border: '1px solid rgba(232,213,176,0.25)', borderRadius: 20, cursor: 'pointer', textAlign: 'center', transition: 'border-color 0.2s, background 0.2s' }}
          ...
          >
            ...
            <p style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 22, color: '#e8d5b0', marginBottom: 8 }}>Studio</p>
          ...
          <button
            ...
            style={{ padding: '40px 28px', background: 'rgba(122,180,232,0.05)', border: '1px solid rgba(122,180,232,0.25)', borderRadius: 20, cursor: 'pointer', textAlign: 'center', transition: 'border-color 0.2s, background 0.2s' }}
          ...
          >
            ...
            <p style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 22, color: '#7ab4e8', marginBottom: 8 }}>Tech</p>
        ...
        <button
          ...
          style={{ marginTop: 20, padding: '10px 24px', background: 'transparent', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 10, color: 'rgba(245,245,247,0.3)', fontSize: 13, cursor: 'pointer', fontFamily: 'var(--font-body)' }}
        >
